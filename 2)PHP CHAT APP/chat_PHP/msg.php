<DOCTYPE html>
    <html>
        ...
        <body style="height:100%; width:100%;">
            ...
            if (mysqli_num_rows($result)==0){
            echo "<li><div style='float:left;'> <p style='padding:10;'>У вас нет новых заявок </p></div></li></ul></div>";
            } else {
                    ...
                    ?>                        
                <button onclick="window.location.href='index.php'" class='btn btn-outline-secondary' style ="float:right;">Главная</button>
        </div>
            ...
            <div class="row" style="height:90%;">
                ...
                <?php
                    ...
                    $result = mysqli_query($conn,$sql);
                    if(!mysqli_num_rows($result)>0){
                        echo "<h3> Ваш список друзей пуст</h3>";
                ...
                <div class ='col-10 shadow-lg p-3 mb-5 bg-body rounded' style = "height: 100%">
                    ...
                    <div class=" row form-floating mb-3">
                      ...
                      <label for="floatingInput">Написать сообщение</label>
                    </div>
                    <div>
                    <button style="float:right; width:15%;" type="submit" class="btn btn-outline-secondary">Отправить</button>    
                    </div>                    
                    </form>
                    </div>
                </div>
